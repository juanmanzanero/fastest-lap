...
if ( steps_1_to_3 )
    ...
    circuit = calllib('libfastestlapc','create_track',[],'catalunya','../../../build/src/test/applications/melbourne_700.xml',options);
    ...
    % (3) Construct car
    vehicle = calllib("libfastestlapc","create_vehicle",[],'vehicle','limebeer-2014-f1','/Users/juanmanzanero/Documents/software/fastest-lap/examples/matlab/australia_optimization/ferrari-2022-australia.xml');
    vehicle_data = readstruct('/Users/juanmanzanero/Documents/software/fastest-lap/examples/matlab/australia_optimization/ferrari-2022-australia.xml');
    % (3) Simulation
    options = '<options>';
...
for i = 2:15352
   h=plot_run_dashboard(i,t_plot,s_plot,x_plot,y_plot,r_center_plot,q_plot,qa_plot,u_plot, x_center_plot, y_center_plot, x_left_plot, y_left_plot,...
       x_right_plot, y_right_plot, run.laptime, vehicle, vehicle_data,-min(min(qa)));   
