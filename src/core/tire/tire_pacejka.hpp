...
{
    const Timeseries_t mu_x_max  = (Fz - _Fz1)*(_mu_x_max2  - _mu_x_max1 )/(_Fz2 - _Fz1) + _mu_x_max1;
...
{
    const Timeseries_t mu_y_max  = (Fz - _Fz1)*(_mu_y_max2  - _mu_y_max1 )/(_Fz2 - _Fz1) + _mu_y_max1;
